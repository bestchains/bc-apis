...
export const ENDORSE_POLICY_CRD_SPEC = {
  kind: 'EndorsePolicy',
  listKind: 'EndorsePolicyList',
  plural: 'endorsepolicies',
  singular: 'endorsepolicy',
  scope: 'Cluster',
  group: 'ibp.com',
  version: 'v1beta1',
};

const { kind, group, version, plural } = ENDORSE_POLICY_CRD_SPEC;
const DEFAULT_BODY = {
  kind,
...
export class EndorsePolicy {
   ...
   * 创建 EndorsePolicy
   *
   * @param {CRD.EndorsePolicy} body EndorsePolicy 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(body: CRD.EndorsePolicy, options?: CreateOptions) {
   ...
   * 替换指定的 EndorsePolicy
   *
   * @param {string} name EndorsePolicy 名称
   * @param {CRD.EndorsePolicy} body EndorsePolicy 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(name: string, body: CRD.EndorsePolicy, options?: CreateOptions) {
  ...
  /**
   * 部分更新指定的 EndorsePolicy (JSON Patch)
   *
   * @param {string} name EndorsePolicy 名称
   * @param {JsonPatchOp[]} body EndorsePolicy patch json 对象
  ...
  /**
   * 部分更新指定的 EndorsePolicy (Merge Patch)
   *
   * @param {string} name EndorsePolicy 名称
   * @param {object} body EndorsePolicy 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  ...
  /**
   * 部分更新指定的 EndorsePolicy (Strategic Merge Patch)
   *
   * @param {string} name EndorsePolicy 名称
   * @param {object} body EndorsePolicy 对象
   * @param {PatchOptions} [options] 可选配置项
