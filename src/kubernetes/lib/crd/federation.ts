...
export const FEDERATION_CRD_SPEC = {
  kind: 'Federation',
...
const { kind, group, version, plural } = FEDERATION_CRD_SPEC;
const DEFAULT_BODY = {
  kind,
...
export class Federation {
   ...
   * 创建 Federation
   *
   * @param {CRD.Federation} body Federation 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(body: CRD.Federation, options?: CreateOptions) {
   ...
   * 替换指定的 Federation
   *
   * @param {string} name Federation 名称
   * @param {CRD.Federation} body Federation 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(name: string, body: CRD.Federation, options?: CreateOptions) {
  ...
  /**
   * 部分更新指定的 Federation (JSON Patch)
   *
   * @param {string} name Federation 名称
   * @param {JsonPatchOp[]} body Federation patch json 对象
  ...
  /**
   * 部分更新指定的 Federation (Merge Patch)
   *
   * @param {string} name Federation 名称
   * @param {object} body Federation 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  ...
  /**
   * 部分更新指定的 Federation (Strategic Merge Patch)
   *
   * @param {string} name Federation 名称
   * @param {object} body Federation 对象
   * @param {PatchOptions} [options] 可选配置项
