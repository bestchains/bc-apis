...
const { kind, group, version, plural } = CHANNEL_CRD_SPEC;
const DEFAULT_BODY = {
  kind,
...
export class Channel {
   ...
   * 创建 Channel
   *
   * @param {CRD.Channel} body Channel 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(body: CRD.Channel, options?: CreateOptions) {
   ...
   * 替换指定的 Channel
   *
   * @param {string} name Channel 名称
   * @param {CRD.Channel} body Channel 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(name: string, body: CRD.Channel, options?: CreateOptions) {
  ...
  /**
   * 部分更新指定的 Channel (JSON Patch)
   *
   * @param {string} name Channel 名称
   * @param {JsonPatchOp[]} body Channel patch json 对象
  ...
  /**
   * 部分更新指定的 Channel (Merge Patch)
   *
   * @param {string} name Channel 名称
   * @param {object} body Channel 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  ...
  /**
   * 部分更新指定的 Channel (Strategic Merge Patch)
   *
   * @param {string} name Channel 名称
   * @param {object} body Channel 对象
   * @param {PatchOptions} [options] 可选配置项
