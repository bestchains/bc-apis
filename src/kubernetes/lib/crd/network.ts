...
const { kind, group, version, plural } = NETWORK_CRD_SPEC;
const DEFAULT_BODY = {
  kind,
...
export class Network {
   ...
   * 创建 Network
   *
   * @param {CRD.Network} body Network 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(body: CRD.Network, options?: CreateOptions) {
   ...
   * 替换指定的 Network
   *
   * @param {string} name Network 名称
   * @param {CRD.Network} body Network 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(name: string, body: CRD.Network, options?: CreateOptions) {
  ...
  /**
   * 部分更新指定的 Network (JSON Patch)
   *
   * @param {string} name Network 名称
   * @param {JsonPatchOp[]} body Network patch json 对象
  ...
  /**
   * 部分更新指定的 Network (Merge Patch)
   *
   * @param {string} name Network 名称
   * @param {object} body Network 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  ...
  /**
   * 部分更新指定的 Network (Strategic Merge Patch)
   *
   * @param {string} name Network 名称
   * @param {object} body Network 对象
   * @param {PatchOptions} [options] 可选配置项
