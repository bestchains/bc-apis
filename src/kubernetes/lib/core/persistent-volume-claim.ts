...
export class PersistentVolumeClaim {
   ...
   */
  create(namespace: string, body: K8s.V1PersistentVolumeClaim, options?: CreateOptions) {
  ...
  read(name: string, namespace: string, options?: ReadOptions) {
    ...
    return this.k8sApi.readNamespacedPersistentVolumeClaim(name, namespace, pretty, { headers });
  }
