...
export class ResourceQuota {
  ...
  create(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.createNamespacedResourceQuota(
      namespace,
      body,
      pretty,
      dryRun,
   ...
   * 替换指定的 ResourceQuota
   *
   * @param {string} name ResourceQuota 名称
   * @param {string} namespace 命名空间
   * @param {K8s.V1ResourceQuota} body ResourceQuota 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.replaceNamespacedResourceQuota(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 ResourceQuota (JSON Patch)
   *
   * @param {string} name ResourceQuota 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body ResourceQuota 对象
  ...
  patch(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, force, headers } =
      options || {};
    return this.k8sApi.patchNamespacedResourceQuota(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 ResourceQuota (Merge Patch)
   *
   * @param {string} name ResourceQuota 名称
   * @param {string} namespace 命名空间
   * @param {object} body ResourceQuota 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  patchMerge(
    name: string,
  ...
  /**
   * 部分更新指定的 ResourceQuota (Strategic Merge Patch)
   *
   * @param {string} name ResourceQuota 名称
   * @param {string} namespace 命名空间
   * @param {object} body ResourceQuota 对象
  ...
  delete(name: string, namespace: string, options?: DeleteOptions) {
    ...
    return this.k8sApi.deleteNamespacedResourceQuota(
      name,
      namespace,
      pretty,
      dryRun,
  ...
  deleteCollection(
    ...
    return this.k8sApi.deleteCollectionNamespacedResourceQuota(
      namespace,
      pretty,
      _continue,
      dryRun,
  ...
  /**
   * 根据名称获取 ResourceQuota 详情 (指定 namespace 下)
   *
   * @param {string} namespace 命名空间
  ...
  list(namespace: string, options?: ListOptions) {
    ...
    return this.k8sApi.listNamespacedResourceQuota(
      namespace,
      pretty,
      allowWatchBookmarks,
      _continue,
  ...
  /**
   * 列取 ResourceQuota 列表 (所有 namespace 下)
   *
   * @param {ListOptions} [options] 可选配置项
   */
  listAll(options?: ListOptions) {
    ...
    return this.k8sApi.listResourceQuotaForAllNamespaces(
      allowWatchBookmarks,
      _continue,
      fieldSelector,
      labelSelector,
