...
export class ReplicationController {
  ...
  create(namespace: string, body: K8s.V1ReplicationController, options?: CreateOptions) {
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.createNamespacedReplicationController(
      namespace,
      body,
      pretty,
      dryRun,
   ...
   *
   * @param {string} name ReplicationController 名称
   * @param {string} namespace 命名空间
   * @param {K8s.V1ReplicationController} body ReplicationController 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.replaceNamespacedReplicationController(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 ReplicationController (JSON Patch)
   *
   * @param {string} name ReplicationController 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body ReplicationController 对象
  ...
  patch(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, force, headers } =
      options || {};
    return this.k8sApi.patchNamespacedReplicationController(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 ReplicationController (Merge Patch)
   *
   * @param {string} name ReplicationController 名称
   * @param {string} namespace 命名空间
   * @param {object} body ReplicationController 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  patchMerge(
    name: string,
  ...
  /**
   * 部分更新指定的 ReplicationController (Strategic Merge Patch)
   *
   * @param {string} name ReplicationController 名称
   * @param {string} namespace 命名空间
   * @param {object} body ReplicationController 对象
  ...
  /**
   * 根据名称删除一个 ReplicationController
   *
   * @param {string} name ReplicationController 名称
   * @param {string} namespace 命名空间
  ...
  delete(name: string, namespace: string, options?: DeleteOptions) {
    ...
    return this.k8sApi.deleteNamespacedReplicationController(
      name,
      namespace,
      pretty,
      dryRun,
  ...
  // <remove is="Service">
  /**
   * 根据选择器删除多个 ReplicationController
   *
   * @param {string} namespace 命名空间
  ...
  deleteCollection(
    ...
    return this.k8sApi.deleteCollectionNamespacedReplicationController(
      namespace,
      pretty,
      _continue,
      dryRun,
  ...
  /**
   * 根据名称获取 ReplicationController 详情 (指定 namespace 下)
   *
   * @param {string} namespace 命名空间
  ...
  list(namespace: string, options?: ListOptions) {
    ...
    return this.k8sApi.listNamespacedReplicationController(
      namespace,
      pretty,
      allowWatchBookmarks,
      _continue,
  ...
  /**
   * 列取 ReplicationController 列表 (所有 namespace 下)
   *
   * @param {ListOptions} [options] 可选配置项
   */
  listAll(options?: ListOptions) {
    ...
    return this.k8sApi.listReplicationControllerForAllNamespaces(
      allowWatchBookmarks,
      _continue,
      fieldSelector,
      labelSelector,
