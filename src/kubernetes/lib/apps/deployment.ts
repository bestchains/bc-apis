...
export class Deployment {
   ...
   * @param {K8s.V1Deployment} body Deployment 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(namespace: string, body: K8s.V1Deployment, options?: CreateOptions) {
    this.debug('[create]', body, options);
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.createNamespacedDeployment(
      namespace,
      body,
      pretty,
      dryRun,
   ...
   * 替换指定的 Deployment
   *
   * @param {string} name Deployment 名称
   * @param {string} namespace 命名空间
   * @param {K8s.V1Deployment} body Deployment 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.replaceNamespacedDeployment(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 Deployment (JSON Patch)
   *
   * @param {string} name Deployment 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body Deployment 对象
  ...
  patch(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, force, headers } =
      options || {};
    return this.k8sApi.patchNamespacedDeployment(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 Deployment (Merge Patch)
   *
   * @param {string} name Deployment 名称
   * @param {string} namespace 命名空间
   * @param {object} body Deployment 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  patchMerge(
    name: string,
  ...
  /**
   * 部分更新指定的 Deployment (Strategic Merge Patch)
   *
   * @param {string} name Deployment 名称
   * @param {string} namespace 命名空间
   * @param {object} body Deployment 对象
  ...
  delete(name: string, namespace: string, options?: DeleteOptions) {
    ...
    return this.k8sApi.deleteNamespacedDeployment(
      name,
      namespace,
      pretty,
      dryRun,
  ...
  deleteCollection(
    ...
    return this.k8sApi.deleteCollectionNamespacedDeployment(
      namespace,
      pretty,
      _continue,
      dryRun,
  ...
  /**
   * 根据名称获取 Deployment 详情 (指定 namespace 下)
   *
   * @param {string} namespace 命名空间
  ...
  list(namespace: string, options?: ListOptions) {
    ...
    return this.k8sApi.listNamespacedDeployment(
      namespace,
      pretty,
      allowWatchBookmarks,
      _continue,
  ...
  /**
   * 列取 Deployment 列表 (所有 namespace 下)
   *
   * @param {ListOptions} [options] 可选配置项
   */
  listAll(options?: ListOptions) {
    ...
    return this.k8sApi.listDeploymentForAllNamespaces(
      allowWatchBookmarks,
      _continue,
      fieldSelector,
      labelSelector,
