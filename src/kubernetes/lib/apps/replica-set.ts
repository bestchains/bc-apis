...
export class ReplicaSet {
   ...
   * @param {K8s.V1ReplicaSet} body ReplicaSet 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(namespace: string, body: K8s.V1ReplicaSet, options?: CreateOptions) {
    this.debug('[create]', body, options);
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.createNamespacedReplicaSet(
      namespace,
      body,
      pretty,
      dryRun,
   ...
   * 替换指定的 ReplicaSet
   *
   * @param {string} name ReplicaSet 名称
   * @param {string} namespace 命名空间
   * @param {K8s.V1ReplicaSet} body ReplicaSet 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.replaceNamespacedReplicaSet(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 ReplicaSet (JSON Patch)
   *
   * @param {string} name ReplicaSet 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body ReplicaSet 对象
  ...
  patch(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, force, headers } =
      options || {};
    return this.k8sApi.patchNamespacedReplicaSet(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 ReplicaSet (Merge Patch)
   *
   * @param {string} name ReplicaSet 名称
   * @param {string} namespace 命名空间
   * @param {object} body ReplicaSet 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  patchMerge(
    name: string,
  ...
  /**
   * 部分更新指定的 ReplicaSet (Strategic Merge Patch)
   *
   * @param {string} name ReplicaSet 名称
   * @param {string} namespace 命名空间
   * @param {object} body ReplicaSet 对象
  ...
  delete(name: string, namespace: string, options?: DeleteOptions) {
    ...
    return this.k8sApi.deleteNamespacedReplicaSet(
      name,
      namespace,
      pretty,
      dryRun,
  ...
  deleteCollection(
    ...
    return this.k8sApi.deleteCollectionNamespacedReplicaSet(
      namespace,
      pretty,
      _continue,
      dryRun,
  ...
  /**
   * 根据名称获取 ReplicaSet 详情 (指定 namespace 下)
   *
   * @param {string} namespace 命名空间
  ...
  read(name: string, namespace: string, options?: ReadOptions) {
    ...
    return this.k8sApi.readNamespacedReplicaSet(name, namespace, pretty, { headers });
  }
  ...
  list(namespace: string, options?: ListOptions) {
    ...
    return this.k8sApi.listNamespacedReplicaSet(
      namespace,
      pretty,
      allowWatchBookmarks,
      _continue,
  ...
  /**
   * 列取 ReplicaSet 列表 (所有 namespace 下)
   *
   * @param {ListOptions} [options] 可选配置项
   */
  listAll(options?: ListOptions) {
    ...
    return this.k8sApi.listReplicaSetForAllNamespaces(
      allowWatchBookmarks,
      _continue,
      fieldSelector,
      labelSelector,
