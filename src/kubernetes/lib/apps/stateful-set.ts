...
export class StatefulSet {
   ...
   * @param {K8s.V1StatefulSet} body StatefulSet 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  create(namespace: string, body: K8s.V1StatefulSet, options?: CreateOptions) {
    this.debug('[create]', body, options);
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.createNamespacedStatefulSet(
      namespace,
      body,
      pretty,
      dryRun,
   ...
   * 替换指定的 StatefulSet
   *
   * @param {string} name StatefulSet 名称
   * @param {string} namespace 命名空间
   * @param {K8s.V1StatefulSet} body StatefulSet 对象
   * @param {CreateOptions} [options] 可选配置项
   */
  replace(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, headers } =
      options || {};
    return this.k8sApi.replaceNamespacedStatefulSet(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 StatefulSet (JSON Patch)
   *
   * @param {string} name StatefulSet 名称
   * @param {string} namespace 命名空间
   * @param {JsonPatchOp[]} body StatefulSet 对象
  ...
  patch(
    ...
    const { pretty, dryRun, fieldManager, fieldValidation, force, headers } =
      options || {};
    return this.k8sApi.patchNamespacedStatefulSet(
      name,
      namespace,
      body,
      pretty,
  ...
  /**
   * 部分更新指定的 StatefulSet (Merge Patch)
   *
   * @param {string} name StatefulSet 名称
   * @param {string} namespace 命名空间
   * @param {object} body StatefulSet 对象
   * @param {PatchOptions} [options] 可选配置项
   */
  patchMerge(
    name: string,
  ...
  /**
   * 部分更新指定的 StatefulSet (Strategic Merge Patch)
   *
   * @param {string} name StatefulSet 名称
   * @param {string} namespace 命名空间
   * @param {object} body StatefulSet 对象
  ...
  delete(name: string, namespace: string, options?: DeleteOptions) {
    ...
    return this.k8sApi.deleteNamespacedStatefulSet(
      name,
      namespace,
      pretty,
      dryRun,
  ...
  deleteCollection(
    ...
    return this.k8sApi.deleteCollectionNamespacedStatefulSet(
      namespace,
      pretty,
      _continue,
      dryRun,
  ...
  /**
   * 根据名称获取 StatefulSet 详情 (指定 namespace 下)
   *
   * @param {string} namespace 命名空间
  ...
  read(name: string, namespace: string, options?: ReadOptions) {
    ...
    return this.k8sApi.readNamespacedStatefulSet(name, namespace, pretty, { headers });
  }
  ...
  list(namespace: string, options?: ListOptions) {
    ...
    return this.k8sApi.listNamespacedStatefulSet(
      namespace,
      pretty,
      allowWatchBookmarks,
      _continue,
  ...
  /**
   * 列取 StatefulSet 列表 (所有 namespace 下)
   *
   * @param {ListOptions} [options] 可选配置项
   */
  listAll(options?: ListOptions) {
    ...
    return this.k8sApi.listStatefulSetForAllNamespaces(
      allowWatchBookmarks,
      _continue,
      fieldSelector,
      labelSelector,
